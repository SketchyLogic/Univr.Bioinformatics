...
A **single-nucleotide polymorphism** in a protein-coding region that **changes the amino acid sequence** of the resulting protein. Contrast with synonymous (silent) SNPs, which alter the codon but not the amino acid due to the degeneracy of the genetic code.

**Scale**: the human genome contains ~10,000–20,000 nsSNPs in protein-coding regions; approximately half of all coding SNPs are nonsynonymous.

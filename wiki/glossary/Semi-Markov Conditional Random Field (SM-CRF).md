...
A **discriminative** sequence labeling model for gene prediction that directly models P(annotation | sequence), in contrast to generative models like [[Generalized Hidden Markov Model (GHMM)|GHMMs]] which model the joint P(sequence, annotation).
